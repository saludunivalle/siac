  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response2 = await Filtro9(
          response.filter((item) => item["id_programa"] === idPrograma),
          process,
        );
  ...
  return (
    <>
      <div>
        ...
        <h3>Seguimiento</h3>
        <CollapsibleButton
          buttonText="Plan de Mejoramiento"
          content={
            <>
        ...
        <CollapsibleButton
          buttonText="Registro Calificado"
          content={
            <>
              <div className="contenido" style={{ textAlign: "center" }}>
                ...
                {avaibleRange(isReg) && (
                  <Button
                    onClick={() =>
                      handleNewTrackingClick("Registro Calificado")
                    }
                    variant="contained"
                    color="primary"
                    style={{ textAlign: "center", margin: "8px" }}
            ...
            <>
              <div className="contenido" style={{ textAlign: "center" }}>
                ...
                {avaibleRange(isAcred) && (
                  <Button
                    onClick={() => handleNewTrackingClick("Acreditación")}
                    variant="contained"
                    color="primary"
                    style={{ textAlign: "center", margin: "8px" }}
                  >
            ...
            <>
              <div className="contenido" style={{ textAlign: "center" }}>
                ...
                {avaibleRange(isConv) && (
                  <Button
                    onClick={() =>
                      handleNewTrackingClick("Convenio Docencia Servicio")
                    }
                    variant="contained"
                    color="primary"
                    style={{ textAlign: "center", margin: "8px" }}
