  ...
  const handleButtonClick = async (buttonValue) => {
    ...
    setSelectedValues((prevSelectedValues) => {
      ...
      if (prevSelectedValues.includes(buttonValue)) {
        newSelectedValues = prevSelectedValues.filter(
          (val) => val !== buttonValue,
        );
      } else {
      ...
      if (
        newSelectedValues.includes("option1") ||
          ...
          <div className="row-container">
            ...
            {filteredData.some(
              ...
              <CollapsibleButton
                ...
                content={renderFilteredTable(
                  Filtro4(filteredData, "Bacteriología y Lab. Clínico"),
                )}
              />
            )}
            {filteredData.some(
              ...
              <CollapsibleButton
                ...
                content={renderFilteredTable(
                  Filtro4(filteredData, "Ciencias Básicas"),
                )}
              />
            )}
            {filteredData.some((data) => data["escuela"] === "Enfermería") && (
              <CollapsibleButton
                ...
                content={renderFilteredTable(
                  Filtro4(filteredData, "Enfermería"),
                )}
              />
            )}
            {filteredData.some((data) => data["escuela"] === "Medicina") && (
              <CollapsibleButton
                ...
                content={renderFilteredTable(Filtro4(filteredData, "Medicina"))}
              />
            )}
            {filteredData.some((data) => data["escuela"] === "Odontología") && (
              <CollapsibleButton
                ...
                content={renderFilteredTable(
                  Filtro4(filteredData, "Odontología"),
                )}
              />
            )}
            {filteredData.some(
              ...
              <CollapsibleButton
                ...
                content={renderFilteredTable(
                  Filtro4(filteredData, "Rehabilitación Humana"),
                )}
              />
            )}
            {filteredData.some(
              ...
              <CollapsibleButton
                ...
                content={renderFilteredTable(
                  Filtro4(filteredData, "Salud Pública"),
                )}
              />
            )}
            {filteredData.some(
              ...
              <CollapsibleButton
                ...
                content={renderFilteredTable(
                  Filtro4(filteredData, "Dirección de Posgrados"),
                )}
              />
            )}
            {filteredData.some(
              ...
              <CollapsibleButton
                ...
                content={renderFilteredTable(
                  Filtro4(filteredData, "No Aplica"),
                )}
              />
            )}
          </div>
